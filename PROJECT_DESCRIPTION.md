...
|---|---|---|---|---|
| Талалаев Иван Владимирович | Product Manager | Продуктовая и бизнесовая часть | Концепция, экономика и план проекта | Активное, сопоставимый вклад |
...
Инженеры совместно отвечают за интеграцию компонентов и демонстрационного прототипа. Ключевые продуктовые и технические решения принимаются всей командой.
